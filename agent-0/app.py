...
from tools.websearch import DuckDuckGoSearchTool
...
# note adding tools gives the agent new capabilities
agent = CodeAgent(
        model=model,
        tools=[final_answer, web_search, visit_webpage],         # here we can always add our tools -on top of the final answer
        max_steps=6,
        verbosity_level=1,
        grammar=None,
